...
<!-- Inicio de sesión usarios y admin-->
<div class="row animate-box">
				<div class="col-md-2  text-center qbootstrap-heading">
					
				    <button class="btn btn-primary btn-lg btn-block" id="btnIniciar">Reportes</button>
				    </div>	
				</div>
</div>
